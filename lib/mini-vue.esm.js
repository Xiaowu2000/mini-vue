...
function createRenderer(options) {
    ...
    function patchElement(n1, n2, container) {
        ...
        patchProps$1(newProps, oldProps, hostPatchProp, el);
    }
...
function patchProps$1(newProps, oldProps, hostPatchProp, el) {
...
const render = createRenderer({ createElement, patchProp: patchProps, insert });
